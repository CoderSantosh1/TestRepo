        ...
        <div className="w-full bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border-b p-4">
              ...
              <p className="text-blue-600 hover:text-blue-800"><a href="https://interbiharboard.com/">LINK-I</a></p>
              <p className="text-blue-600 hover:text-blue-800"><a href="https://results.biharboardonline.com/Seniorsecondary25/">LINK-II</a></p>
